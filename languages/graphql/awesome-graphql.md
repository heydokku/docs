...
* [typescript-graphql-request](https://graphql-code-generator.com/docs/plugins/typescript-graphql-request) - 7.4k stars Use GraphQL Request as a fully typed SDK.
https://github.com/chentsulin/awesome-graphql

* [aws-amplify](https://github.com/aws-amplify/amplify-js) - 8.4k stars A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.

* [graphql-hooks](https://github.com/nearform/graphql-hooks) - 1.1k stars Minimal hooks-first GraphQL client with caching and server-side rendering support.

* [graphql-request](https://github.com/prisma/graphql-request) - A minimal GraphQL client for Node and browsers.

* [urql] 6.3k (https://github.com/FormidableLabs/urql) - A simple caching GraphQL client for React.
...
* [How to GraphQL](https://www.howtographql.com) - 7.8k Fullstack Tutorial Website with Tracks for all Major Frameworks & Languages including React, Apollo, Relay, JavaScript, Ruby, Java, Elixir and many more
